...
PRODUCTS_JSON_FILE="/workspace/search_fundamentals/opensearch/bbuy_products.json"
QUERIES_JSON_FILE="/workspace/search_fundamentals/opensearch/bbuy_queries.json"
DATASETS_DIR="/workspace/datasets"
PYTHON_LOC="/workspace/search_fundamentals/week1"
